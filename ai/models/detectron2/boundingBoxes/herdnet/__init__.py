'''
    AIDE/Detectron2-compliant wrapper for the HerdNet models:
	...
	"options": {
		...
		"model": {
			...
			"config": {
				...
				"type": "select",
				"value": "boundingBoxes/deepforest/deepforest.yaml",
				"options": {
					"boundingBoxes/deepforest/deepforest.yaml": {
						"name": "DeepForest release"
					},
					"boundingBoxes/deepforest/birddetector.yaml": {
						"name": "Bird Detector release"
					}
				}
			},
			"force": {
